...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL;//"http://www.ss.node/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl: window.WEB_HOME_URL + "ueditor/imageUp"             //图片上传提交地址
        ,imagePath: window.PUB_HOME_URL + "uploads/common"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
